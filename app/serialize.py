...
def spec_to_json(s: CompositionSpec) -> dict:
    ...
    # Every field is always emitted. The omit-at-default branches that used to live
    # here served the retired forever-contract (byte-identical re-stamping of old
    # manifests -- see docs/superpowers/specs/2026-07-27-retire-the-forever-contract-
    # design.md). With that promise gone, an always-full payload is simpler and more
    # self-describing; spec_from_json's read-tolerance still opens any older file.
    return d
